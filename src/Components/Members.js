            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex flex-wrap -m-4 text-center ">
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg hover:bg-site_color-400 hover:shadow-2xl Member_hover">
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-site_color-400  w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
