...
const Eventpage = () => {
    return ( 
        ...
        <div className="flex justify-evenly items-center lg:flex-row md:flex-row  flex-col ">
            <button className="mt-20 bg-white px-6 py-3 lg:text-xl border-l-4 border-secondary hover:drop-shadow-xl blog-buttons font-medium min-w-[17%] ">Upcoming Events</button>
            <button  className="mt-20 bg-white px-6 py-3 lg:text-xl border-l-4 border-secondary hover:drop-shadow-xl blog-buttons font-medium min-w-[17%] ">Past Events</button>
        </div>
