...
function MemberCard(props) {
    ...
    return (
        ...
        <div className="max-w-sm  overflow-hidden bg-white rounded-lg shadow-lg hover:shadow-xl scale-[0.8] hover:border-[#2f2e2e]  member-card hover:drop-shadow-xl sm:scale-1 mb-0 hover:scale-[0.9]">
