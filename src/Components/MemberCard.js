...
function MemberCard(props) {
    ...
    return (
        ...
        {/* <div class="max-w-sm  overflow-hidden bg-white rounded-lg shadow-lg hover:shadow-xl scale-[0.8] hover:border-[#2f2e2e]  member-card hover:drop-shadow-xl sm:scale-1 mb-0 hover:scale-[0.9]">
            <img class="object-cover object-center w-full h-56" src={demo} alt="avatar" />


            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-800 ">{props.name}</h1>
                ...
                <div class="flex items-center mt-4 text-gray-700">
                    ...
                    <h1 class="px-2 text-sm">{props.role}</h1>
                </div>
    ...
    <div class="max-w-xs mx-auto bg-white shadow-lg  overflow-hidden rounded-full hover:shadow-xl scale-[0.8] hover:border-[#2f2e2e]  hover:drop-shadow-xl sm:scale-1 mb-0 hover:scale-[0.9]">
        ...
        <div class="py-5 text-center">
            <a href="#" class="block text-2xl font-bold text-gray-800 ">{props.name}</a>
            <span class="text-sm text-gray-700">{props.role}</span>
        </div>
    </div>
