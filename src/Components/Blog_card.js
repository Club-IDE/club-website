    ...
    <>
      ...
      <div>
        <div className='countiner bg-white border-2 border-gray-100 shadow-lg w-[90%] lg:w-[60%] m-auto h-[max-content] my-10 px-8 pt-10 lg:px-14 relative top-[0px] lg:top-[-400px] pb-10'>
          <h1 className='h1 text-2xl font-bold lg:text-5xl'>Learn the hidden feature in Git - Stash</h1>
          <div className='pt-5'>
          ...
          <div className='flex mt-5'>
            ...
            <span>
              <h4 className='mx-5 my-0'>SHLOK JADEJA</h4>
              <h2 className='text-gray-400 text-sm ml-4'>April 14 Originally Publlish at <a href='/'><span className='text-primary'> ClubIDE.com </span></a>| 5 min read</h2>
            </span>
          </div>
          <div className='pt-20'>
